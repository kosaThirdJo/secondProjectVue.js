        ...
        <a class="click-meetingpost">
          <div class="meetinginfo">
            ...
            <div class="meeting-body">
              <p class="meeting-body-content">{{description}}</p>
            </div>
            <!--게시글 항목 하단-->
            <div class="meeting-footer">
              <div class="meeting-cratedata">
                <span class="meeting-footer-text">작성일</span>
                <span class="meeting-footer-content-text">{{creationDate}}</span>
              </div>
              <div class="meeing-location">
                <span class="meeting-footer-text">장소</span>
                <span class="meeting-footer-content-text">{{location}}</span>
              </div>
              <div class="meeting-count">
                <span class="meeting-footer-text">신청인원</span>
                <span class="meeting-footer-content-text">{{ applicationCount+ ` / ` + recruitmentCount}}</span>
              </div>
              <div class="meeting-deadline">
                <span class="meeting-footer-text">모집마감일</span>
                <span class="meeting-footer-content-text">{{ applicationDeadline }}</span>
              </div>
              <div class="meeting-view">
                <span class="meeting-footer-text">조회수</span>
                <span class="meeting-footer-content-text">{{ views }}</span>
              </div>
            </div>
          </div>
        </a>
